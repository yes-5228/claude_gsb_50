export const NAV_ITEMS = [
  ...
  { to: '/standards', label: '限值标准', icon: '📏', title: '限值标准版本', subtitle: '维护标准版本、等级与生效时间, 按监测时间匹配限值' },
...
export const STANDARD_GRADE_LABELS = { grade1: '一级标准', grade2: '二级标准' }
export const STANDARD_GRADE_TONE = { grade1: 'warning', grade2: 'info' }
export const STANDARD_STATUS_LABELS = { current: '现行有效', historical: '历史版本', pending: '尚未生效' }
export const STANDARD_STATUS_TONE = { current: 'success', historical: 'neutral', pending: 'info' }
