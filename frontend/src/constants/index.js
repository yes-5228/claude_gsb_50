export const NAV_ITEMS = [
  ...
  { to: '/standards', label: '限值标准', icon: '📏', title: '限值标准管理', subtitle: '维护标准版本、等级与生效时间, 按监测时间匹配判定依据' }
]
...
export const STANDARD_STATUS_TONE = { active: 'success', scheduled: 'info', retired: 'neutral' }
export const STANDARD_GRADE_TONE = { level1: 'warning', level2: 'primary' }
